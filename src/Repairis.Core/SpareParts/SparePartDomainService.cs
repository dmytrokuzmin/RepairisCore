...
namespace Repairis.SpareParts
{
    public class SparePartDomainService : DomainService, ISparePartDomainService
    {
        ...
        public SparePartDomainService(IRepository<SparePart> sparePartRepository)
        {
        ...
        {
            var sparePart = _sparePartRepository.Get(sparePartId);
            ...
            if (existingMapping != null)
            {
                ...
                existingMapping.PricePerItem = (existingMapping.PricePerItem * existingMapping.Quantity + pricePerItem * quantity) / (existingMapping.Quantity + quantity);
